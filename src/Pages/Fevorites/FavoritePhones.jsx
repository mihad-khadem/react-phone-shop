const FavoritePhones = ({ phone }) => {
  ...
  return (
    <div>
      <div>
        <div className="relative flex w-full max-w-[38rem] flex-row rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
          ...
          <div className="p-6">
            <h6 className="mb-4 block font-sans text-base font-semibold uppercase leading-relaxed tracking-normal text-sky-500 antialiased">
              {rating}
            </h6>
